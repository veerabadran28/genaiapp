...
def create_final_dataset(cd, jd, sds_data=None):
    """Create final dataset by joining Polars company data with Pandas judgment data and SDS data."""
    ...
    if sds_data is not None:
        ...
        # Set ClientFlag to False for unmatched records
        final_data["ClientFlag"] = final_data["ClientFlag"].fillna(False)
...
def load_and_process_data():
    ...
    final_data = create_final_dataset(cd, jd, sds_data)
